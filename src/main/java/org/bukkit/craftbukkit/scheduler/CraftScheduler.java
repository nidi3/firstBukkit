    ...
    public void run() {
        ...
        while (true) {
                        ...
                        if (first != null) {
                            ...
                            if (currentTick >= firstTick) {
                                ...
                                if (first.getPeriod() >= 0) {
                                   ...
                                   logger.info("at "+currentTick+" next "+ first.getExecutionTick());
            ...
            if (first == null) {
                ...
                currentTick = getCurrentTick();
                sleepTime = (firstTick - currentTick) * 10 + 5;
            }
            ...
            logger.info("s "+sleepTime+" tick "+currentTick);
...
//
//                }
//                mainThreadHeartbeat(getCurrentTick()+1);
//                }
//            }
//        }).start();
